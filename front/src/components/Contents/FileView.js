...
export class FileView extends React.Component {
  ...
  searchView() {
    ...
    return (
      <div
        className="search"
        style={{ display: showSetting ? "grid" : "none" }}
      >
        <select
